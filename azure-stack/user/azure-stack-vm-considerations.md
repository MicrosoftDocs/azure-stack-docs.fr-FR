...
- Pour les disques de machine virtuelle, les IOPS (opérations d’entrée/sortie par seconde) de disque sur Azure Stack dépendent de la taille de la machine virtuelle et non du type de disque. Cela signifie que, pour une machine virtuelle Standard_Fs, quel que soit le type de disque choisi (SSD ou HDD), la limite d'IOPS est de 2 300 par disque de données supplémentaire.
