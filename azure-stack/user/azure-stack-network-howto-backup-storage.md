...
5.  Entrez le **compte de stockage**, la **clé SAS** et le **chemin du répertoire local**.  Vous allez les utiliser pour copier des données de façon incrémentielle vers le compte de stockage **cible**.
