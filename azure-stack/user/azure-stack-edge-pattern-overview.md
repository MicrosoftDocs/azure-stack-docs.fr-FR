---
title: Modèles de conception de clouds hybrides pour Azure Stack | Microsoft Docs
description: Vue d’ensemble des modèles pour le cloud hybride et la périphérie intelligente avec Azure Stack
...
ms.locfileid: "68286877"
---
# <a name="hybrid-cloud-design-patterns-for-azure-stack"></a>Modèles de conception de clouds hybrides pour Azure Stack
...
-   [Développer des modèles Azure Resource Manager pour la cohérence du cloud](http://aka.ms/consistency)