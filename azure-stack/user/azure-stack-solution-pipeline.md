...
* Utilisez un système intégré Azure Stack ou déployez le Kit de développement Azure Stack (ASDK). Pour déployer l’ASDK :
  * Le [Didacticiel : déployer le kit de développement Azure Stack à l’aide du programme d’installation](../asdk/asdk-install.md) fournit des instructions de déploiement détaillées.
