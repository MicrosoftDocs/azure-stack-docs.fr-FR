...
Le service Azure App Service simplifie l’exécution et la gestion d’une application web. Étant donné qu’Azure Stack est cohérent avec Azure, le service App Service peut s’exécuter dans les deux environnements. Vous utiliserez App Service pour héberger votre application.
