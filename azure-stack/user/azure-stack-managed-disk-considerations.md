...
> [!NOTE]  
> La cmdlet Azure PowerShell **ConvertTo-AzVMManagedDisk** ne peut pas être utilisée pour convertir un disque non managé en disque managé dans Azure Stack Hub. Azure Stack Hub ne prend pas en charge cette cmdlet pour l’instant.
