...
1. Configurez PowerShell. Pour obtenir des instructions, consultez [Installer Azure Stack Hub PowerShell](../operator/powershell-install-az-module.md). 
