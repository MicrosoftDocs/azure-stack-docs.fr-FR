...
>[!NOTE]  
>Les disques créés et managés par Azure sont appelés [disques managés](https://docs.microsoft.com/azure/virtual-machines/windows/managed-disks-overview).
