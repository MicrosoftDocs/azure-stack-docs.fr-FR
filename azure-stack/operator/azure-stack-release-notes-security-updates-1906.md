---
title: Notes de publication Azure Stack – Mises à jour de sécurité pour 1906 | Microsoft Docs
description: Découvrez les mises à jour de sécurité 1906 pour Azure Stack.
...
En raison de la nature cumulative des mises à jour de Windows, cette mise à jour contient également des charges utiles de sécurité des mois précédents. La liste des CVE ci-dessus reflète la charge utile de sécurité de mars, d’avril et de mai 2019.
Pour plus d’informations sur ces vulnérabilités, cliquez sur les liens précédents ou consultez l’article [4499177](https://support.microsoft.com/en-us/help/4499177) de la Base de connaissances Microsoft.

## <a name="1904-update"></a>Mise à jour 1904

Cette mise à jour d’Azure Stack n’inclut pas les mises à jour de sécurité pour le système d’exploitation sous-jacent qui héberge Azure Stack.

## <a name="1903-update"></a>Mise à jour 1903

Cette mise à jour d’Azure Stack n’inclut pas les mises à jour de sécurité pour le système d’exploitation sous-jacent qui héberge Azure Stack.  

## <a name="1902-update"></a>Mise à jour 1902

Cette mise à jour 1902 installe les mises à jour de sécurité suivantes :  
