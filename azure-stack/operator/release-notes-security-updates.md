...
ms.locfileid: "94547005"
---
# <a name="azure-stack-hub-security-updates"></a>Mises à jour de sécurité Azure Stack Hub

Cet article répertorie toutes les mises à jour de sécurité contenues dans les trois dernières mises à jour d’Azure Stack Hub. Ces informations sont fournies à titre de référence uniquement.

::: moniker range="azs-2008"
## <a name="2008-update"></a>Mise à jour 2008

En raison de la nature cumulative des mises à jour de Windows, cette mise à jour contient les charges utiles de sécurité pour les mois précédents. Cette liste de CVE reflète les charges utiles de sécurité depuis la dernière mise à jour. Ces mises à jour sont contenues dans la [mise à jour mensuelle du mois d’août 2020](https://support.microsoft.com/en-us/help/4565349/windows-10-update-kb4565349).

Pour plus d’informations sur ces vulnérabilités, cliquez sur les liens ci-dessous.
...
En raison de la nature cumulative des mises à jour de Windows, cette mise à jour contient les charges utiles de sécurité pour les mois précédents. Cette liste de CVE reflète les charges utiles de sécurité depuis la dernière mise à jour complète, [Février 2020](https://portal.msrc.microsoft.com/en-us/security-guidance/releasenotedetail/2020-Feb), [Mars 2020](https://portal.msrc.microsoft.com/en-us/security-guidance/releasenotedetail/2020-Mar), [Avril 2020](https://portal.msrc.microsoft.com/en-us/security-guidance/releasenotedetail/2020-Apr), [Mai 2020](https://portal.msrc.microsoft.com/en-us/security-guidance/releasenotedetail/2020-May), [Juin 2020](https://portal.msrc.microsoft.com/en-us/security-guidance/releasenotedetail/2020-Jun) et [Juillet 2020](https://portal.msrc.microsoft.com/en-us/security-guidance/releasenotedetail/2020-Jul).
Pour plus d’informations sur ces vulnérabilités, cliquez sur les liens ci-dessous.
...
## <a name="2002-update"></a>Mise à jour 2002

En raison de la nature cumulative des mises à jour de Windows, cette mise à jour contient les charges utiles de sécurité pour les mois précédents. Cette liste de CVE reflète les charges utiles de sécurité depuis la dernière mise à jour complète, couvrant ainsi [Octobre 2019](https://portal.msrc.microsoft.com/en-us/security-guidance/releasenotedetail/2019-Oct), [Novembre 2019](https://portal.msrc.microsoft.com/en-us/security-guidance/releasenotedetail/2019-Nov), [Décembre 2019](https://portal.msrc.microsoft.com/en-us/security-guidance/releasenotedetail/2019-Dec) et [Janvier 2020](https://portal.msrc.microsoft.com/en-us/security-guidance/releasenotedetail/2020-Jan).
Pour plus d’informations sur ces vulnérabilités, cliquez sur les liens ci-dessous ou consultez l’article [4534273](https://support.microsoft.com/en-us/help/4534273) de la Base de connaissances Microsoft.
