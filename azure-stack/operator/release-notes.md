...
> [!TIP]
> Si vous souhaitez être averti de chaque mise en production de correctif logiciel, abonnez-vous au [**flux RSS**](https://azurestackhubdocs.azurewebsites.net/xml/hotfixes.rss).
