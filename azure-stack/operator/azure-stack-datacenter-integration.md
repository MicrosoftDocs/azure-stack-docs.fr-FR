...
- **Azure Stack à client unique**. Un déploiement d’Azure Stack qui semble, au moins du point de vue de la mise en réseau, être un seul locataire. Il peut y avoir beaucoup d’abonnements clients, mais comme tout service intranet, tout le trafic transite sur les mêmes réseaux. Le trafic provenant d’un abonnement transite sur la même connexion réseau qu’un autre abonnement et n’a pas besoin d’être isolé via un tunnel chiffré.

- **Azure Stack mutualisé**. Un déploiement d’Azure Stack, dans lequel le trafic de l’abonnement de chaque locataire lié pour les réseaux externes à Azure Stack, doit être isolé du trafic des autres locataires.
...
- Vous devriez utiliser ce même partage pour la sauvegarde des commutateurs réseau et l’hôte de cycle de vie du matériel. Votre fabricant de matériel OEM aidera à fournir des conseils pour la sauvegarde et la restauration de ces composants étant donné qu’ils ne font pas partie de Azure Stack. Vous êtes responsable d’exécuter les workflows de sauvegarde basés sur la recommandation du fabricant OEM.
