...
4. Sur la gauche, sous **Général**, sélectionnez **Nœuds**.
   ...
   - Quantité totale de mémoire
     ...
     ![état d’une unité d’échelle](media/azure-stack-node-actions/multinode-actions.png)
...
Cette action est généralement utilisée lorsqu’un nœud ne répond pas.
...
[Découvrez le module opérateur Azure Stack Hub Fabric](/powershell/module/azs.fabric.admin/?view=azurestackps-1.6.0).