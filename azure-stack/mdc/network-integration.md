...
|Passerelle VPN Azure|     |     |[Consulter les questions fréquentes (FAQ) sur la passerelle VPN](/azure/vpn-gateway/vpn-gateway-vpn-faq#can-i-traverse-proxies-and-firewalls-using-point-to-site-capability)|
|     |     |     |     |