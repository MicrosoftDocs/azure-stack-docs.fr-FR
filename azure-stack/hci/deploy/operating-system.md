...
Pour plus d’informations sur l’utilisation de VMM afin d’effectuer un déploiement complet du système d’exploitation, consultez [Configurer un hôte ou un cluster Hyper-V à partir de systèmes nus](/system-center/vmm/hyper-v-bare-metal?view=sc-vmm-2019).
