...
![Azure CLI sur l'emplacement Python Azure Stack Hub](media/azure-stack-version-profiles-azure-cli-2/cli-python-location.png)
...
![Sortie de la création du groupe de ressources](media/azure-stack-connect-cli/image-1.png)
...
- [Gérer les autorisations utilisateur](../../user/azure-stack-manage-permissions.md) 