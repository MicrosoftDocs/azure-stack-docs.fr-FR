...
## <a name="what-about-other-vms-that-use-windows-server-such-as-sql-server"></a>Qu’en est-il des autres machines virtuelles qui utilisent Windows Server, par exemple SQL Server ?
