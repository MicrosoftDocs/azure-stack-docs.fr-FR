...
* Workflow SolutionValidation : [Valider une nouvelle solution Azure Stack](azure-stack-vaas-validate-solution-new.md)
...
- [Module Azure Stack](/powershell/azure/azure-stack/overview?view=azurestackps-1.6.0)
